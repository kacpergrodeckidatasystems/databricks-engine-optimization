...
class TestEndToEndLocal:
    """Full E2E scenarios on local Spark server."""

    def test_platform_detection_vanilla_spark(self, environment_type):
        """Verification whether local engine correctly identifies environment."""
        # Use official, unified project environment fixture
        assert environment_type == "local"

    def test_error_handling_invalid_table(self):
        """Verification whether missing table returns correct SKIPPED status."""
